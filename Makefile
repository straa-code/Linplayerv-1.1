#############################################################################
# Makefile for building: 文档
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  文档.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile 文档.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = 文档1.0.0
DISTDIR = /home/li/文档/.tmp/文档1.0.0
LINK          = g++
...
Makefile: 文档.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents nb.cpp www.cpp $(DISTDIR)/
...
nb.o: nb.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o nb.o nb.cpp

www.o: www.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o www.o www.cpp
